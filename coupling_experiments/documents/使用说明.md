...
详见 `theory_markdown/` 目录：
- [theory.md](../theory_markdown/theory.md) - G Dominance 猜想的完整理论文档
- [Lyapunov_energy_analysis.md](../theory_markdown/Lyapunov_energy_analysis.md) - Lyapunov 能量分析
- [知识文档.md](../theory_markdown/知识文档.md) - 投影动力系统与凸序理论
...
```json
{
    "l0": 50,        // prefill length
    "l_A": 4,        // Type A decode length
    "l_B": 7,        // Type B decode length (需与 l_A 互质)
    "B": 1000,       // GPU capacity (tokens)
...
| `G_comparison.png` | G^T vs G^S |
| `G_decomposed.png` | G 分解图（2×4） |
| `roots_analysis.png` | 特征方程根（复平面） |

#### Delta 分析可视化（验证 G Dominance）
| 文件 | 说明 |
|------|------|
| `delta_extrema.png` | **核心**：Δ_{m^S} ≥ 0 验证 |
| `delta_heatmap.png` | Δ 向量时空热力图 |
| `case_distribution.png` | Case A/B/C/D 分布 |
...
| `analysis_dashboard.png` | 综合仪表板（2×3） |

#### 数据文件
| 文件 | 说明 |
|------|------|
| `trajectory.csv` | 每个 batch 的基础数据 |
| `delta_analysis.csv` | Δ 向量分析 |
| `lyapunov_analysis.csv` | 能量数据 |
...
- [实现细节.md](实现细节.md) - 代码实现细节
- [第四阶段_特征方程的根的可视化.md](第四阶段_特征方程的根的可视化.md) - 根分析理论背景
- [theory.md](../theory_markdown/theory.md) - G Dominance 猜想完整理论
- [Lyapunov_energy_analysis.md](../theory_markdown/Lyapunov_energy_analysis.md) - Lyapunov 能量方法
- [知识文档.md](../theory_markdown/知识文档.md) - 投影动力系统与凸序理论
