...
class LLMSchedulerSimulator:
    def __init__(self, l0, l1, B, X0, Qe0, lambda_rate, b0, b1):
        """
        初始化模拟器
    ...
    def update(self):
        ...
        print(f"n={self.n}, T={self.T:.3f}: after AE, X={X_prime}, Qe={self.Qe:.3f}, Qr={self.Qr}, admission={admission}, eviction={eviction}, flow_Z={flow_Z}, Z={Z}, s={s:.3f}")
        self.T += s
...
if __name__ == "__main__":
    ...
    l1 = 2
    B = 140  # GPU容量
    X0 = [0, 21]  # 初始状态 (B/2, 0), 注意初始状态直接爆炸
    Qe0 = 1000  # 初始外部队列
    lambda_rate = 18.2  # 到达率
    b0 = 0.1
    b1 = 0.01
